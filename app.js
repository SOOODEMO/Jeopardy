...
const jeopardyCategories = [
  {
    ...
    questions: [
      ...
      {
        question: 'Who was the 1st U.S Predsident?',
        answers: ['Donald Trump', 'George Washington'],
        correct: 'George Washington',
        level: 'medium',
      },
      {
        question: 'Who invented Coding?',
        answers: ['Ada Lovelace', 'Lady Byron'],
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: 'Where did the Aztec Empire Take place at?',
        answers: ['America', 'Mexico'],
        correct: 'Mexico',
        level: 'medium',
      },
      {
        question: 'Where did Queen Victoria die?',
        answers: ['London', 'Osborne'],
        correct: 'Osborne',
        level: 'hard',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        question: 'When was Anime released?',
        answers: ['1907', '1917'],
        correct: '1907',
        level: 'hard',
      },
